const u16 *const gLevelUpLearnsets[NUM_SPECIES] =
{
    ...
    [SPECIES_KAKUNA] = sMetapodLevelUpLearnset, // Kakuna doesn't need a level up learnset of its own
    ...
    [SPECIES_MACHAMP] = sMachokeLevelUpLearnset, // Machamp doesn't need a level up learnset of its own
    ...
    [SPECIES_JUMPLUFF] = sSkiploomLevelUpLearnset, // Jumpluff doesn't need a level yp learnset of its own
    ...
    [SPECIES_SILCOON] = sMetapodLevelUpLearnset, // Silcoon doesn't need a level up learnset of its own
    [SPECIES_BEAUTIFLY] = sBeautiflyLevelUpLearnset,
    [SPECIES_CASCOON] = sMetapodLevelUpLearnset, // Cascoon doesn't need a level up learnset of its own
