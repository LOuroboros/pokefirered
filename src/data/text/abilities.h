...
static const u8 sSteadfastDescription[] = _("Raises SPEED if flinched.");
static const u8 sSnowCloakDescription[] = _("Raises evasion in a hailstorm.");
static const u8 sGluttonyDescription[] = _("Eats berries sooner.");
static const u8 sAngerPointDescription[] = _("This is a placeholder."); // To Do
static const u8 sUnburdenDescription[] = _("This is a placeholder."); // To Do
static const u8 sHeatproofDescription[] = _("This is a placeholder."); // To Do
static const u8 sSimpleDescription[] = _("This is a placeholder."); // To Do
static const u8 sDrySkinDescription[] = _("This is a placeholder."); // To Do
static const u8 sDownloadDescription[] = _("This is a placeholder."); // To Do
static const u8 sIronFistDescription[] = _("This is a placeholder."); // To Do
static const u8 sPoisonHealDescription[] = _("Restores HP when poisoned.");
static const u8 sAdaptabilityDescription[] = _("This is a placeholder."); // To Do
static const u8 sSkillLinkDescription[] = _("This is a placeholder."); // To Do
static const u8 sHydrationDescription[] = _("This is a placeholder."); // To Do
static const u8 sSolarPowerDescription[] = _("This is a placeholder."); // To Do
static const u8 sQuickFeetDescription[] = _("This is a placeholder."); // To Do
static const u8 sNormalizeDescription[] = _("This is a placeholder."); // To Do
static const u8 sSniperDescription[] = _("This is a placeholder."); // To Do
static const u8 sMagicGuardDescription[] = _("The user avoids indirect damage.");
static const u8 sNoGuardDescription[] = _("This is a placeholder."); // To Do
static const u8 sStallDescription[] = _("This is a placeholder."); // To Do
static const u8 sTechnicianDescription[] = _("This is a placeholder."); // To Do
static const u8 sLeafGuardDescription[] = _("This is a placeholder."); // To Do
static const u8 sKlutzDescription[] = _("This is a placeholder."); // To Do
static const u8 sMoldBreakerDescription[] = _("This is a placeholder."); // To Do
static const u8 sSuperLuckDescription[] = _("This is a placeholder."); // To Do
static const u8 sAftermathDescription[] = _("This is a placeholder."); // To Do
static const u8 sAnticipationDescription[] = _("This is a placeholder."); // To Do
static const u8 sForewarnDescription[] = _("This is a placeholder."); // To Do
static const u8 sUnawareDescription[] = _("This is a placeholder."); // To Do
static const u8 sTintedLensDescription[] = _("This is a placeholder."); // To Do
static const u8 sFilterDescription[] = _("This is a placeholder."); // To Do
static const u8 sSlowStartDescription[] = _("This is a placeholder."); // To Do
static const u8 sScrappyDescription[] = _("This is a placeholder."); // To Do
static const u8 sStormDrainDescription[] = _("This is a placeholder."); // To Do
static const u8 sIceBodyDescription[] = _("Regains HP in a hailstorm.");
static const u8 sSolidRockDescription[] = _("This is a placeholder."); // To Do
static const u8 sSnowWarningDescription[] = _("This is a placeholder."); // To Do
...
static const u8 sRecklessDescription[] = _("This is a placeholder."); // To Do
...
// Gen. 4 Abilities
    ...
    [ABILITY_ANGER_POINT]  = sAngerPointDescription, // To Do
    [ABILITY_UNBURDEN]     = sUnburdenDescription, // To Do
    [ABILITY_HEATPROOF]    = sHeatproofDescription, // To Do
    [ABILITY_SIMPLE]       = sSimpleDescription, // To Do
    [ABILITY_DRY_SKIN]     = sDrySkinDescription, // To Do
    [ABILITY_DOWNLOAD]     = sDownloadDescription, // To Do
    [ABILITY_IRON_FIST]    = sIronFistDescription, // To Do
    [ABILITY_POISON_HEAL]  = sPoisonHealDescription,
    [ABILITY_ADAPTABILITY] = sAdaptabilityDescription, // To Do
    [ABILITY_SKILL_LINK]   = sSkillLinkDescription, // To Do
    [ABILITY_HYDRATION]    = sHydrationDescription, // To Do
    [ABILITY_SOLAR_POWER]  = sSolarPowerDescription, // To Do
    [ABILITY_QUICK_FEET]   = sQuickFeetDescription, // To Do
    [ABILITY_NORMALIZE]    = sNormalizeDescription, // To Do
    [ABILITY_SNIPER]       = sSniperDescription, // To Do
    [ABILITY_MAGIC_GUARD]  = sMagicGuardDescription,
    [ABILITY_NO_GUARD]     = sNoGuardDescription, // To Do
    [ABILITY_STALL]        = sStallDescription, // To Do
    [ABILITY_TECHNICIAN]   = sTechnicianDescription, // To Do
    [ABILITY_LEAF_GUARD]   = sLeafGuardDescription, // To Do
    [ABILITY_KLUTZ]        = sKlutzDescription, // To Do
    [ABILITY_MOLD_BREAKER] = sMoldBreakerDescription, // To Do
    [ABILITY_SUPER_LUCK]   = sSuperLuckDescription, // To Do
    [ABILITY_AFTERMATH]    = sAftermathDescription, // To Do
    [ABILITY_ANTICIPATION] = sAnticipationDescription, // To Do
    [ABILITY_FOREWARN]     = sForewarnDescription, // To Do
    [ABILITY_UNAWARE]      = sUnawareDescription, // To Do
    [ABILITY_TINTED_LENS]  = sTintedLensDescription, // To Do
    [ABILITY_FILTER]       = sFilterDescription, // To Do
    [ABILITY_SLOW_START]   = sSlowStartDescription, // To Do
    [ABILITY_SCRAPPY]      = sScrappyDescription, // To Do
    [ABILITY_STORM_DRAIN]  = sStormDrainDescription, // To Do
    [ABILITY_ICE_BODY]     = sIceBodyDescription,
    [ABILITY_SOLID_ROCK]   = sSolidRockDescription, // To Do
    [ABILITY_SNOW_WARNING] = sSnowWarningDescription, // To Do
    [ABILITY_HONEY_GATHER] = sHoneyGatherDescription, // To Do
    [ABILITY_FRISK]        = sFriskDescription, // To Do
    [ABILITY_RECKLESS]     = sRecklessDescription, // To Do
...
// Gen. 4 Abilities
    [ABILITY_TANGLED_FEET] = _("TANGLED FEET"), // To Do
    [ABILITY_MOTOR_DRIVE]  = _("MOTOR DRIVE"), // To Do
    [ABILITY_RIVALRY]      = _("RIVALRY"), // To Do
    [ABILITY_STEADFAST]    = _("STEADFAST"), // To Do
    [ABILITY_SNOW_CLOAK]   = _("SNOW CLOAK"), // To Do
    [ABILITY_GLUTTONY]     = _("GLUTTONY"),
    [ABILITY_ANGER_POINT]  = _("ANGER POINT"), // To Do
    [ABILITY_UNBURDEN]     = _("UNBURDEN"), // To Do
    [ABILITY_HEATPROOF]    = _("HEATPROOF"), // To Do
    [ABILITY_SIMPLE]       = _("SIMPLE"), // To Do
    [ABILITY_DRY_SKIN]     = _("DRY SKIN"), // To Do
    [ABILITY_DOWNLOAD]     = _("DOWNLOAD"), // To Do
    [ABILITY_IRON_FIST]    = _("IRON FIST"), // To Do
    [ABILITY_POISON_HEAL]  = _("POISON HEAL"), // To Do
    [ABILITY_ADAPTABILITY] = _("ADAPTABILITY"), // To Do
    [ABILITY_SKILL_LINK]   = _("SKILL LINK"), // To Do
    [ABILITY_HYDRATION]    = _("HYDRATION"), // To Do
    [ABILITY_SOLAR_POWER]  = _("SOLAR POWER"), // To Do
    [ABILITY_QUICK_FEET]   = _("QUICK FEET"), // To Do
    [ABILITY_NORMALIZE]    = _("NORMALIZE"), // To Do
    [ABILITY_SNIPER]       = _("SNIPER"), // To Do
    [ABILITY_MAGIC_GUARD]  = _("MAGIC GUARD"), // To Do
    [ABILITY_NO_GUARD]     = _("NO GUARD"), // To Do
    [ABILITY_STALL]        = _("STALL"), // To Do
    [ABILITY_TECHNICIAN]   = _("TECHNICIAN"), // To Do
    [ABILITY_LEAF_GUARD]   = _("LEAF GUARD"), // To Do
    [ABILITY_KLUTZ]        = _("KLUTZ"), // To Do
    [ABILITY_MOLD_BREAKER] = _("MOLD BREAKER"), // To Do
    [ABILITY_SUPER_LUCK]   = _("SUPER LUCK"), // To Do
    [ABILITY_AFTERMATH]    = _("AFTERMATH"), // To Do
    [ABILITY_ANTICIPATION] = _("ANTICIPATION"), // To Do
    [ABILITY_FOREWARN]     = _("FOREWARN"), // To Do
    [ABILITY_UNAWARE]      = _("UNAWARE"), // To Do
    [ABILITY_TINTED_LENS]  = _("TINTED LENS"), // To Do
    [ABILITY_FILTER]       = _("FILTER"), // To Do
    [ABILITY_SLOW_START]   = _("SLOW START"), // To Do
    [ABILITY_SCRAPPY]      = _("SCRAPPY"), // To Do
    [ABILITY_STORM_DRAIN]  = _("STORM DRAIN"), // To Do
    [ABILITY_ICE_BODY]     = _("ICE BODY"), // To Do
    [ABILITY_SOLID_ROCK]   = _("SOLID ROCK"), // To Do
    [ABILITY_SNOW_WARNING] = _("SNOW WARNING"), // To Do
    [ABILITY_HONEY_GATHER] = _("HONEY GATHER"), // To Do
    [ABILITY_FRISK]        = _("FRISK"), // To Do
    [ABILITY_RECKLESS]     = _("RECKLESS"), // To Do
