...
static const u8 sFilterDescription[] = _("Weakens the foe's “Super effective” hits.");
...
static const u8 sSolidRockDescription[] = _("Weakens the foe's “Super effective” hits.");
