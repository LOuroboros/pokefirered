...
gMoveDescriptionPointers:: @ 84886E8
	...
	.4byte gMoveDescription_Roost
	.4byte gMoveDescription_Gravity
	.4byte gMoveDescription_MiracleEye
	.4byte gMoveDescription_WakeUpSlap
	.4byte gMoveDescription_HammerArm
	.4byte gMoveDescription_GyroBall
	.4byte gMoveDescription_HealingWish
	.4byte gMoveDescription_Brine
	.4byte gMoveDescription_NaturalGift
	.4byte gMoveDescription_Feint
	.4byte gMoveDescription_Pluck
	.4byte gMoveDescription_Tailwind
	.4byte gMoveDescription_Acupressure
	.4byte gMoveDescription_MetalBurst
	.4byte gMoveDescription_UTurn
	.4byte gMoveDescription_CloseCombat
	.4byte gMoveDescription_Payback
	.4byte gMoveDescription_Assurance
	.4byte gMoveDescription_Embargo
	.4byte gMoveDescription_Fling
	.4byte gMoveDescription_PsychoShift
	.4byte gMoveDescription_TrumpCard
	.4byte gMoveDescription_HealBlock
	.4byte gMoveDescription_WringOut
	.4byte gMoveDescription_PowerTrick
	.4byte gMoveDescription_GastroAcid
	.4byte gMoveDescription_LuckyChant
	.4byte gMoveDescription_MeFirst
	.4byte gMoveDescription_Copycat
	.4byte gMoveDescription_PowerSwap
	.4byte gMoveDescription_GuardSwap
	.4byte gMoveDescription_Punishment
	.4byte gMoveDescription_LastResort
	.4byte gMoveDescription_WorrySeed
	.4byte gMoveDescription_SuckerPunch
	.4byte gMoveDescription_ToxicSpikes
	.4byte gMoveDescription_HeartSwap
	.4byte gMoveDescription_AquaRing
	.4byte gMoveDescription_MagnetRise
	.4byte gMoveDescription_FlareBlitz
	.4byte gMoveDescription_ForcePalm
	.4byte gMoveDescription_AuraSphere
	.4byte gMoveDescription_RockPolish
	.4byte gMoveDescription_PoisonJab
	.4byte gMoveDescription_DarkPulse
	.4byte gMoveDescription_NightSlash
	.4byte gMoveDescription_AquaTail
	.4byte gMoveDescription_SeedBomb
	.4byte gMoveDescription_AirSlash
	.4byte gMoveDescription_XScissor
	.4byte gMoveDescription_BugBuzz
	.4byte gMoveDescription_DragonPulse
	.4byte gMoveDescription_DragonRush
	.4byte gMoveDescription_PowerGem
	.4byte gMoveDescription_DrainPunch
	.4byte gMoveDescription_VacuumWave
	.4byte gMoveDescription_FocusBlast
	.4byte gMoveDescription_EnergyBall
	.4byte gMoveDescription_BraveBird
	.4byte gMoveDescription_EarthPower
	.4byte gMoveDescription_Switcheroo
	.4byte gMoveDescription_GigaImpact
	.4byte gMoveDescription_NastyPlot
	.4byte gMoveDescription_BulletPunch
	.4byte gMoveDescription_Avalanche
	.4byte gMoveDescription_IceShard
	.4byte gMoveDescription_ShadowClaw
	.4byte gMoveDescription_ThunderFang
	.4byte gMoveDescription_IceFang
	.4byte gMoveDescription_FireFang
	.4byte gMoveDescription_ShadowSneak
	.4byte gMoveDescription_MudBomb
	.4byte gMoveDescription_PsychoCut
	.4byte gMoveDescription_ZenHeadbutt
	.4byte gMoveDescription_MirrorShot
	.4byte gMoveDescription_FlashCannon
	.4byte gMoveDescription_RockClimb
	.4byte gMoveDescription_Defog
	.4byte gMoveDescription_TrickRoom
	.4byte gMoveDescription_DracoMeteor
	.4byte gMoveDescription_Discharge
	.4byte gMoveDescription_LavaPlume
	.4byte gMoveDescription_LeafStorm
	.4byte gMoveDescription_PowerWhip
	.4byte gMoveDescription_RockWrecker
	.4byte gMoveDescription_CrossPoison
	.4byte gMoveDescription_GunkShot
	.4byte gMoveDescription_IronHead
	.4byte gMoveDescription_MagnetBomb
	.4byte gMoveDescription_StoneEdge
	.4byte gMoveDescription_Captivate
	.4byte gMoveDescription_StealthRock
	.4byte gMoveDescription_GrassKnot
	.4byte gMoveDescription_Chatter
	.4byte gMoveDescription_Judgment
	.4byte gMoveDescription_BugBite
	.4byte gMoveDescription_ChargeBeam
	.4byte gMoveDescription_WoodHammer
	.4byte gMoveDescription_AquaJet
	.4byte gMoveDescription_AttackOrder
	.4byte gMoveDescription_DefendOrder
	.4byte gMoveDescription_HealOrder
	.4byte gMoveDescription_HeadSmash
	.4byte gMoveDescription_DoubleHit
	.4byte gMoveDescription_RoarOfTime
	.4byte gMoveDescription_SpacialRend
	.4byte gMoveDescription_LunarDance
	.4byte gMoveDescription_CrushGrip
	.4byte gMoveDescription_MagmaStorm
	.4byte gMoveDescription_DarkVoid
	.4byte gMoveDescription_SeedFlare
	.4byte gMoveDescription_OminousWind
	.4byte gMoveDescription_ShadowForce
